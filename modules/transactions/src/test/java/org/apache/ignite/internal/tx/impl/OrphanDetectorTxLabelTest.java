...
public class OrphanDetectorTxLabelTest extends BaseIgniteAbstractTest {
    ...
    void txLabelIsPresentInDeadlockExceptionMessageWhenLockIsMarkedAbandoned() {
        ...
        txStateMetaStorage.updateMeta(
                orphanTxId,
                old -> new TxStateMeta(PENDING, LOCAL_NODE_ID, zonePartitionId, null, null, null, null, null, orphanLabel, null)
        );
        txStateMetaStorage.updateMeta(
                concurrentTxId,
                old -> new TxStateMeta(PENDING, LOCAL_NODE_ID, zonePartitionId, null, null, null, null, null, concurrentLabel, null)
        );
