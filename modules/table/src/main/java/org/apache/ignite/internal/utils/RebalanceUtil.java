...
public class RebalanceUtil {
     ...
     */
    public static @NotNull CompletableFuture<StatementResult> updatePendingAssignmentsKeys(String partId, Collection<ClusterNode> baselineNodes,
        ...
        byte[] partAssignmentsBytes = ByteUtils.toBytes(AffinityUtils.calculateAssignments(baselineNodes, partitions, replicas).get(partNum));
