...
public class TxRetryBenchmark0 extends ClusterPerTestIntegrationTest {
    @Override
    ...
    private void measure(
        ...
        for (int i = 0; i < cores; i++) {
            ...
            futures.add(executor.submit(() -> doTxs(view, transactions, untilTime, keyUpperBound, txCounter, opsTime)));
        }
        ...
        System.out.printf("avg duration: %f\n", avgDuration);
    }
