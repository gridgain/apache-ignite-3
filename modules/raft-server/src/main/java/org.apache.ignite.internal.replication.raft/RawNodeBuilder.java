...
import org.apache.ignite.internal.replication.raft.message.tmp.TestMessageFactory;
...
import org.apache.ignite.internal.replication.raft.storage.tmp.TestEntryFactory;
...
public class RawNodeBuilder {
    ...
    public <T> RawNode<T> build() {
        ...
        RaftLog raftLog = new RaftLog(logger, storage, entryFactory == null ? new TestEntryFactory(): entryFactory, cfg.maxCommittedSizePerReady());
        ...
        RawNode<T> r = new RawNode<T>(
            ...
            cfg.preVote(),
            cfg.readOnlyOption(),
            msgFactory == null ? new TestMessageFactory() : msgFactory,
            entryFactory == null ? new TestEntryFactory(): entryFactory,
            logger,
            rnd);
