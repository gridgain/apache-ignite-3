...
import org.apache.ignite.raft.ElectionPriority;
 ...
 */
public class PeerIdImpl implements PeerId, Serializable {
    ...
    public PeerIdImpl(PeerIdImpl peer) {
        this.node = peer.getNode();
        this.priority = peer.getPriority();
    }

    public PeerIdImpl(Node node) {
        this(node, ElectionPriority.DISABLED);
    }

    public PeerIdImpl(final Node node, final int priority) {
        super();
        this.node = node;
    ...
    @Override public boolean equals(Object o) {
        ...
        PeerIdImpl peerId = (PeerIdImpl) o;
